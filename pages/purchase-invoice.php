...
<input type="hidden" id="invoiceMode" value="purchase">
<input type="hidden" id="invoiceCsrfToken" value="<?php echo csrf_token(); ?>">

<div class="card" id="invoiceListView">
    <div class="page-actions">
        <a href="#" class="button invoice-new" data-type="purchase_invoice">+ فاکتور خرید جدید</a>
        <a href="#" class="button-secondary invoice-new" data-type="purchase_proforma">+ پیش فاکتور خرید</a>
        <div class="filter-panel">
            <input type="search" id="invoiceSearch" placeholder="جستجو (شماره/تامین‌کننده)...">
    ...
    <div class="table-wrapper">
        <table class="action-table" id="invoicesTable">
            <thead>
                <tr>
                    <th>شماره</th><th>تامین‌کننده</th><th>تاریخ (شمسی)</th><th>نوع</th><th>وضعیت پرداخت</th><th>مبلغ کل</th><th>عملیات</th>
                </tr>
            </thead>
            <tbody>
